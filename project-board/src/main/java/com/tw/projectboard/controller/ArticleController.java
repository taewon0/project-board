...
import com.tw.projectboard.dto.request.ArticleRequest;
import com.tw.projectboard.dto.response.ArticleResponse;
import com.tw.projectboard.dto.response.ArticleWithCommentsResponse;
...
public class ArticleController {
    ...
    public String updateArticle(@PathVariable(name = "articleId") Long articleId,
                                @AuthenticationPrincipal BoardPrincipal boardPrincipal,
                                ArticleRequest articleRequest) {
